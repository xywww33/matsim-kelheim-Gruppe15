...
@CommandLine.Command(header = ":: Open Kelheim Scenario ::", version = MyRunKelheimScenario3.VERSION, mixinStandardHelpOptions = true)
...
public class MyRunKelheimScenario3 extends MATSimApplication {
	...
	public MyRunKelheimScenario3(@Nullable Config config) {
		super(config);
	}

	public MyRunKelheimScenario3() {
		super(String.format("input/v%s/kelheim-v%s-config.xml", VERSION, VERSION));
	}

	public static void main(String[] args) {
		MATSimApplication.run(MyRunKelheimScenario3.class, args);
	}
